...
public class ItemBeritaBigAdapter extends RecyclerView.Adapter<ItemBeritaBigAdapter.GridViewHolder> implements ViewPager.OnAdapterChangeListener {
  ...
  public ItemBeritaBigAdapter(Context context, ArrayList<BeritaData> beritaDataArrayList, ArrayList<String> keyItem) {
  ...
  @NonNull
  @Override
  public ItemBeritaBigAdapter.GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_slide_news_big, parent, false);
    return new GridViewHolder(view);
  }

  @Override
  public void onBindViewHolder(@NonNull ItemBeritaBigAdapter.GridViewHolder holder, @SuppressLint("RecyclerView") int position) {
